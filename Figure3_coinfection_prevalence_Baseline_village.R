...
ASX_triple_vil_base_mod_fit <- predict.lm( ASX_triple_vil_base_mod, data.frame(ASX_triple_vil_base_exp=prev_seq), interval="prediction", se.fit=TRUE)

ASX_triple_vil_base_mod_fit$fit[which(ASX_triple_vil_base_mod_fit$fit[,2] < 0),2] <- 1e-10
...
GAM_double_vil_base_mod_fit <- predict.lm( GAM_double_vil_base_mod, data.frame(x_exp=prev_seq), interval="prediction", se.fit=TRUE)

GAM_double_vil_base_mod_fit$fit[which(GAM_double_vil_base_mod_fit$fit[,2] < 0),2] <- 1e-10
...
GAM_triple_vil_base_mod_fit <- predict.lm( GAM_triple_vil_base_mod, data.frame(GAM_triple_vil_base_exp=prev_seq), interval="prediction", se.fit=TRUE)

GAM_triple_vil_base_mod_fit$fit[which(GAM_triple_vil_base_mod_fit$fit[,2] < 0),2] <- 1e-10
...
tiff( file="Figure3_coinfection_prevalence_Baseline_village.tif", width=18, height=18, units="cm", res=500)
...
points(x=prev_seq^ff, y=ASX_double_vil_base_mod_fit$fit[,1]^ff, type='l', lwd=1.5, lty="solid")

polygon(x=c(prev_seq^ff, rev(prev_seq^ff)), 
	  y=c( ASX_double_vil_base_mod_fit$fit[,2]^ff, rev(ASX_double_vil_base_mod_fit$fit[,3]^ff) ),
...
for(v in 1:N_village)
{
	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,1,1]^ff, yy=ASX_double_obs_vil_base[v,1,1]^ff, rr=rr.size1, 
	                     left_colour=Pf_col, right_colour=Pf_col)

	arrows(x0=ASX_double_exp_vil_base[v,1,1]^ff, y0=ASX_double_obs_low_vil_base[v,1,1]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,1,1]^ff, y1=ASX_double_obs_high_vil_base[v,1,1]^ff, 
...
for(v in 1:N_village)
{
	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,2,2]^ff, yy=ASX_double_obs_vil_base[v,2,2]^ff, rr=rr.size1, 
      	               left_colour=Pv_col, right_colour=Pv_col)

	arrows(x0=ASX_double_exp_vil_base[v,2,2]^ff, y0=ASX_double_obs_low_vil_base[v,2,2]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,2,2]^ff, y1=ASX_double_obs_high_vil_base[v,2,2]^ff, 
...
for(v in 1:N_village)
{	
	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,3,3]^ff, yy=ASX_double_obs_vil_base[v,3,3]^ff, rr=rr.size1, 
	                     left_colour=Pm_col, right_colour=Pm_col)

	arrows(x0=ASX_double_exp_vil_base[v,3,3]^ff, y0=ASX_double_obs_low_vil_base[v,3,3]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,3,3]^ff, y1=ASX_double_obs_high_vil_base[v,3,3]^ff, 
...
for(v in 1:N_village)
{
	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,4,4]^ff, yy=ASX_double_obs_vil_base[v,4,4]^ff, rr=rr.size1, 
	                     left_colour=Po_col, right_colour=Po_col)

	arrows(x0=ASX_double_exp_vil_base[v,4,4]^ff, y0=ASX_double_obs_low_vil_base[v,4,4]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,4,4]^ff, y1=ASX_double_obs_high_vil_base[v,4,4]^ff, 
...
for(v in 1:N_village)
{
	arrows(x0=ASX_double_exp_vil_base[v,1,2]^ff, y0=ASX_double_obs_low_vil_base[v,1,2]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,1,2]^ff, y1=ASX_double_obs_high_vil_base[v,1,2]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,1,2]^ff, yy=ASX_double_obs_vil_base[v,1,2]^ff, rr=rr.size2, 
...
for(v in 1:N_village)
{	
	arrows(x0=ASX_double_exp_vil_base[v,1,3]^ff, y0=ASX_double_obs_low_vil_base[v,1,3]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,1,3]^ff, y1=ASX_double_obs_high_vil_base[v,1,3]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,1,3]^ff, yy=ASX_double_obs_vil_base[v,1,3]^ff, rr=rr.size2, 
...
for(v in 1:N_village)
{	
	arrows(x0=ASX_double_exp_vil_base[v,1,4]^ff, y0=ASX_double_obs_low_vil_base[v,1,4]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,1,4]^ff, y1=ASX_double_obs_high_vil_base[v,1,4]^ff, 
	    	 length=0.03, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,1,4]^ff, yy=ASX_double_obs_vil_base[v,1,4]^ff, rr=rr.size2, 
...
for(v in 1:N_village)
{
	arrows(x0=ASX_double_exp_vil_base[v,2,3]^ff, y0=ASX_double_obs_low_vil_base[v,2,3]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,2,3]^ff, y1=ASX_double_obs_high_vil_base[v,2,3]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,2,3]^ff, yy=ASX_double_obs_vil_base[v,2,3]^ff, rr=rr.size2, 
...
for(v in 1:N_village)
{
	arrows(x0=ASX_double_exp_vil_base[v,2,4]^ff, y0=ASX_double_obs_low_vil_base[v,2,4]^ff, 
	     	 x1=ASX_double_exp_vil_base[v,2,4]^ff, y1=ASX_double_obs_high_vil_base[v,2,4]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,2,4]^ff, yy=ASX_double_obs_vil_base[v,2,4]^ff, rr=rr.size2, 
...
for(v in 1:N_village)
{
	arrows(x0=ASX_double_exp_vil_base[v,3,4]^ff, y0=ASX_double_obs_low_vil_base[v,3,4]^ff, 
     		 x1=ASX_double_exp_vil_base[v,3,4]^ff, y1=ASX_double_obs_high_vil_base[v,3,4]^ff, 
    		 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=ASX_double_exp_vil_base[v,3,4]^ff, yy=ASX_double_obs_vil_base[v,3,4]^ff, rr=rr.size2, 
...
points(x=prev_seq^ff, y=ASX_triple_vil_base_mod_fit$fit[,1]^ff, type='l', lwd=1.5, lty="solid")

polygon(x=c(prev_seq^ff, rev(prev_seq^ff)), 
	  y=c( ASX_triple_vil_base_mod_fit$fit[,2]^ff, rev(ASX_triple_vil_base_mod_fit$fit[,3]^ff) ),
	  col=rgb(100/256,100/256,100/256,0.1), border=NA)
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=ASX_triple_vil_base_exp[0*N_village+v]^ff, yy=ASX_triple_vil_base_obs[0*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pv_col, colour_2=Pm_col, colour_3=Po_col)

	arrows(x0=ASX_triple_vil_base_exp[0*N_village+v]^ff, y0=ASX_triple_vil_base_obs_low[0*N_village+v]^ff, 
	     	 x1=ASX_triple_vil_base_exp[0*N_village+v]^ff, y1=ASX_triple_vil_base_obs_high[0*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=ASX_triple_vil_base_exp[1*N_village+v]^ff, yy=ASX_triple_vil_base_obs[1*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pf_col, colour_2=Pm_col, colour_3=Po_col)

	arrows(x0=ASX_triple_vil_base_exp[1*N_village+v]^ff, y0=ASX_triple_vil_base_obs_low[1*N_village+v]^ff, 
	     	 x1=ASX_triple_vil_base_exp[1*N_village+v]^ff, y1=ASX_triple_vil_base_obs_high[1*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=ASX_triple_vil_base_exp[2*N_village+v]^ff, yy=ASX_triple_vil_base_obs[2*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pf_col, colour_2=Pv_col, colour_3=Po_col)

	arrows(x0=ASX_triple_vil_base_exp[2*N_village+v]^ff, y0=ASX_triple_vil_base_obs_low[2*N_village+v]^ff, 
	     	 x1=ASX_triple_vil_base_exp[2*N_village+v]^ff, y1=ASX_triple_vil_base_obs_high[2*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=ASX_triple_vil_base_exp[3*N_village+v]^ff, yy=ASX_triple_vil_base_obs[3*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pf_col, colour_2=Pv_col, colour_3=Pm_col)

	arrows(x0=ASX_triple_vil_base_exp[3*N_village+v]^ff, y0=ASX_triple_vil_base_obs_low[3*N_village+v]^ff, 
	     	 x1=ASX_triple_vil_base_exp[3*N_village+v]^ff, y1=ASX_triple_vil_base_obs_high[3*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
points(x=prev_seq^ff, y=GAM_double_vil_base_mod_fit$fit[,1]^ff, type='l', lwd=1.5, lty="solid")

polygon(x=c(prev_seq^ff, rev(prev_seq^ff)), 
	  y=c( GAM_double_vil_base_mod_fit$fit[,2]^ff, rev(GAM_double_vil_base_mod_fit$fit[,3]^ff) ),
	  col=rgb(100/256,100/256,100/256,0.1), border=NA)
...
for(v in 1:N_village)
{
	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,1,1]^ff, yy=GAM_double_obs_vil_base[v,1,1]^ff, rr=rr.size1, 
	                     left_colour=Pf_col, right_colour=Pf_col)

	arrows(x0=GAM_double_exp_vil_base[v,1,1]^ff, y0=GAM_double_obs_low_vil_base[v,1,1]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,1,1]^ff, y1=GAM_double_obs_high_vil_base[v,1,1]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col=Pf_col, lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,2,2]^ff, yy=GAM_double_obs_vil_base[v,2,2]^ff, rr=rr.size1, 
      	               left_colour=Pv_col, right_colour=Pv_col)

	arrows(x0=GAM_double_exp_vil_base[v,2,2]^ff, y0=GAM_double_obs_low_vil_base[v,2,2]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,2,2]^ff, y1=GAM_double_obs_high_vil_base[v,2,2]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col=Pv_col, lwd=arrow.size)	
}
...
for(v in 1:N_village)
{	
	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,3,3]^ff, yy=GAM_double_obs_vil_base[v,3,3]^ff, rr=rr.size1, 
	                     left_colour=Pm_col, right_colour=Pm_col)

	arrows(x0=GAM_double_exp_vil_base[v,3,3]^ff, y0=GAM_double_obs_low_vil_base[v,3,3]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,3,3]^ff, y1=GAM_double_obs_high_vil_base[v,3,3]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col=Pm_col, lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,4,4]^ff, yy=GAM_double_obs_vil_base[v,4,4]^ff, rr=rr.size1, 
	                     left_colour=Po_col, right_colour=Po_col)

	arrows(x0=GAM_double_exp_vil_base[v,4,4]^ff, y0=GAM_double_obs_low_vil_base[v,4,4]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,4,4]^ff, y1=GAM_double_obs_high_vil_base[v,4,4]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col=Po_col, lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	arrows(x0=GAM_double_exp_vil_base[v,1,2]^ff, y0=GAM_double_obs_low_vil_base[v,1,2]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,1,2]^ff, y1=GAM_double_obs_high_vil_base[v,1,2]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,1,2]^ff, yy=GAM_double_obs_vil_base[v,1,2]^ff, rr=rr.size2, 
	                     left_colour=Pf_col, right_colour=Pv_col)
}
...
for(v in 1:N_village)
{	
	arrows(x0=GAM_double_exp_vil_base[v,1,3]^ff, y0=GAM_double_obs_low_vil_base[v,1,3]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,1,3]^ff, y1=GAM_double_obs_high_vil_base[v,1,3]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,1,3]^ff, yy=GAM_double_obs_vil_base[v,1,3]^ff, rr=rr.size2, 
	                     left_colour=Pf_col, right_colour=Pm_col)
}
...
for(v in 1:N_village)
{	
	arrows(x0=GAM_double_exp_vil_base[v,1,4]^ff, y0=GAM_double_obs_low_vil_base[v,1,4]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,1,4]^ff, y1=GAM_double_obs_high_vil_base[v,1,4]^ff, 
	    	 length=0.03, angle=90, code=3, col="black", lwd=arrow.size)	
...
for(v in 1:N_village)
{
	arrows(x0=GAM_double_exp_vil_base[v,2,3]^ff, y0=GAM_double_obs_low_vil_base[v,2,3]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,2,3]^ff, y1=GAM_double_obs_high_vil_base[v,2,3]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,2,3]^ff, yy=GAM_double_obs_vil_base[v,2,3]^ff, rr=rr.size2, 
	                     left_colour=Pv_col, right_colour=Pm_col)
}
...
for(v in 1:N_village)
{
	arrows(x0=GAM_double_exp_vil_base[v,2,4]^ff, y0=GAM_double_obs_low_vil_base[v,2,4]^ff, 
	     	 x1=GAM_double_exp_vil_base[v,2,4]^ff, y1=GAM_double_obs_high_vil_base[v,2,4]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,2,4]^ff, yy=GAM_double_obs_vil_base[v,2,4]^ff, rr=rr.size2, 
	                     left_colour=Pv_col, right_colour=Po_col)
}
...
for(v in 1:N_village)
{
	arrows(x0=GAM_double_exp_vil_base[v,3,4]^ff, y0=GAM_double_obs_low_vil_base[v,3,4]^ff, 
     		 x1=GAM_double_exp_vil_base[v,3,4]^ff, y1=GAM_double_obs_high_vil_base[v,3,4]^ff, 
    		 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	

	semi_circle_plotter( xx=GAM_double_exp_vil_base[v,3,4]^ff, yy=GAM_double_obs_vil_base[v,3,4]^ff, rr=rr.size2, 
	                     left_colour=Pm_col, right_colour=Po_col)
}
...
points(x=prev_seq^ff, y=GAM_triple_vil_base_mod_fit$fit[,1]^ff, type='l', lwd=1.5, lty="solid")

polygon(x=c(prev_seq^ff, rev(prev_seq^ff)), 
	  y=c( GAM_triple_vil_base_mod_fit$fit[,2]^ff, rev(GAM_triple_vil_base_mod_fit$fit[,3]^ff) ),
	  col=rgb(100/256,100/256,100/256,0.1), border=NA)
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=GAM_triple_vil_base_exp[0*N_village+v]^ff, yy=GAM_triple_vil_base_obs[0*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pv_col, colour_2=Pm_col, colour_3=Po_col)

	arrows(x0=GAM_triple_vil_base_exp[0*N_village+v]^ff, y0=GAM_triple_vil_base_obs_low[0*N_village+v]^ff, 
	     	 x1=GAM_triple_vil_base_exp[0*N_village+v]^ff, y1=GAM_triple_vil_base_obs_high[0*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=GAM_triple_vil_base_exp[1*N_village+v]^ff, yy=GAM_triple_vil_base_obs[1*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pf_col, colour_2=Pm_col, colour_3=Po_col)

	arrows(x0=GAM_triple_vil_base_exp[1*N_village+v]^ff, y0=GAM_triple_vil_base_obs_low[1*N_village+v]^ff, 
	     	 x1=GAM_triple_vil_base_exp[1*N_village+v]^ff, y1=GAM_triple_vil_base_obs_high[1*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=GAM_triple_vil_base_exp[2*N_village+v]^ff, yy=GAM_triple_vil_base_obs[2*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pf_col, colour_2=Pv_col, colour_3=Po_col)

	arrows(x0=GAM_triple_vil_base_exp[2*N_village+v]^ff, y0=GAM_triple_vil_base_obs_low[2*N_village+v]^ff, 
	     	 x1=GAM_triple_vil_base_exp[2*N_village+v]^ff, y1=GAM_triple_vil_base_obs_high[2*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
...
for(v in 1:N_village)
{
	tri_circle_plotter( xx=GAM_triple_vil_base_exp[3*N_village+v]^ff, yy=GAM_triple_vil_base_obs[3*N_village+v]^ff, rr=rr.size2, 
	                     colour_1=Pf_col, colour_2=Pv_col, colour_3=Pm_col)

	arrows(x0=GAM_triple_vil_base_exp[3*N_village+v]^ff, y0=GAM_triple_vil_base_obs_low[3*N_village+v]^ff, 
	     	 x1=GAM_triple_vil_base_exp[3*N_village+v]^ff, y1=GAM_triple_vil_base_obs_high[3*N_village+v]^ff, 
	    	 length=arrow.edge, angle=90, code=3, col="black", lwd=arrow.size)	
}
